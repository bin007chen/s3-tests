...
@attr(resource='bucket')
@attr(method='get')
@attr(operation='list-objects-v2')
@attr(assertion='non-slash delimiter characters')
@attr('list-objects-v2')
...
@attr(assertion='non-printable delimiter can be specified')
@attr('list-objects-v2')
def test_bucketv2_list_delimiter_unreadable():
    key_names=['bar', 'baz', 'cab', 'foo']
    bucket_name = _create_objects(keys=key_names)
    client = get_client()
...
@attr(operation='list-objects-v2')
@attr('list-objects-v2')
def test_bucket_listv2_owner_notempty():
...
@attr(operation='list-objects-v2')
@attr('list-objects-v2')
def test_bucket_listv2_owner_defaultempty():
    key_names = ['foo/bar', 'foo/baz', 'quux']
    bucket_name = _create_objects(keys=key_names)
    client = get_client()
...
@attr(operation='list-objects-v2')
@attr('list-objects-v2')
def test_bucket_listv2_owner_empty():
    key_names = ['foo/bar', 'foo/baz', 'quux']
    bucket_name = _create_objects(keys=key_names)
    client = get_client()
